...
class InceptionV4(nn.Module):
    ...
    def __init__(self, A=4, B=7, C=3, k=192, l=224, m=256, n=384, class_nums=10, tmp_scale = True):
...
def inceptionv4(num_classes = 10, tmp_scale = True):
    return InceptionV4(4, 7, 3, class_nums = num_classes, tmp_scale = tmp_scale)
